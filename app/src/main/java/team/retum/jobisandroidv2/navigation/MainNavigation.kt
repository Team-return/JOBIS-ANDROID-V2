...
internal fun NavGraphBuilder.mainNavigation(
    ...
    navigation(
        ...
        root(
            ...
            onBookmarkClick = navigator::navigateToBookmark,
            onBookmarkBackClick = navigator::popBackStackIfNotHome,
            onRecruitmentsClick = navigator::navigateToRecruitments,
            ...
            onHomeTabClick = navigator::navigateToRoot,
            onRecruitmentsTabClick = navigator::navigateToRecruitments,
            onReviewTabClick = navigator::navigateToReview,
